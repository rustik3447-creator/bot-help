...
TOKEN = os.environ.get("BOT_TOKEN", "8785665273:AAFikmkrKRnR9rYr4RoiSicvgDfGqz-VSeY")
...
def smoking_part1_info(message):
  text = (
      ...
      " яка доступна або відкрита для населення вільно, чи за запрошенням, або"
      " за плату, постійно, періодично або час від часу, в тому числі під'їзди,"
      " а також підземні переходи, стадіони.\n\n"
      "📌 **Стаття 13 Закону № 2899-IV:**\n"
      "1) у ліфтах і таксофонах;\n2) у приміщеннях та на території закладів"
      " охорони здоров’я;\n3) у приміщеннях та на території навчальних"
      " закладів;\n4) на дитячих майданчиках;\n5) у приміщеннях та на території"
      " спортивних і фізкультурно-оздоровчих споруд та закладів фізичної"
      " культури і спорту;\n6) у під’їздах житлових будинків;\n7) у підземних"
      " переходах;\n8) у транспорті загального користування, що"
      " використовується для перевезення пасажирів;\n9) у приміщеннях закладів"
