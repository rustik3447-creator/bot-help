...
def get_main_menu():
  ...
  markup.add(
      "🚸 ст. 184 Невиконання обов'язків", '🏫 ст. 173-4 Булінг'
  )
...
def get_algorithms_menu():
  ...
  markup.add('👶 Дії у разі правопорушення дитиною до 14 років')
  markup.add('👶 Дії у разі правопорушення дитиною від 14 до 16 років')
  markup.add('👦 Дії у разі правопорушення дитиною від 16 до 18 років')
  markup.add('🔙 Головне меню')
  return markup
...
@bot.message_handler(
    func=lambda message: bool(message.text)
    and ('127' in message.text or 'пішоход' in message.text.lower())
)
def art127_info(message):
  text = (
      '🚶 **ПРИКЛАДИ ФАБУЛ ЗА ч. 1 ст. 127 КУпАП (Пішоходи)**\n\n'
      ...
      '🔹 На автомобільній дорозі М-06 «Київ-Чоп» 328км. пішохід рухаючись за'
      ' межами населеного пункту, по краю проїзної частини, йшов в напрямку'
      ' руху транспортних засобів, чим порушив п. 4.3 ПДР.\n\n'
      '🔹 На автомобільній дорозі М-06 «Київ-Чоп» 328км. пішохід рухаючись за'
      ' межами населеного пункту, по краю проїзної частини, вів мотоцикл (мопед,'
      ' велосипед) йшов назустріч руху транспортних засобів, чим порушив п. 4.3'
      ' ПДР.\n\n'
...
def art122_parking_info(message):
  text = (
      '🚘 **Порушення правил стоянки (ст. 122 КУпАП)**\n\n'
      '11.04.2023р. о 12 год. 00 хв. в м. Рівне по вул. Соборна 10 водій керуючи'
      ' транспортним засобом ЗАЗ 969, НЗ АА0101АА, порушив правила стоянки, а'
      ' саме здійснив стоянку:\n\n'
      '• керуючи вантажним транспортним засобом ЗИЛ 130, НЗ АА0101АА, порушив'
      ' правила стоянки, а саме здійснив **стоянку на тротуарі**, чим порушив'
      ' п.15.10б ПДР.\n'
      '• **на тротуарі**, де для руху пішоходів залишається менше 1.5 метри,'
      ' чим порушив п.15.10в ПДР.\n'
...
def under14_algorithm_info(message):
  text = (
      ...
      ' малолітніми, віком до 14 років**\n\n'
      '📌 *Примітка: в такому випадку завжди складається протокол за ч. 1 ст. 184'
      ' КУпАП.*\n\n'
      '🔹 **Алгоритм дій:**\n'
      '1. Фіксація правопорушення.\n'
      '2. Встановлення особи.\n'
      '3. Повідомити батьків, адміністрацію навчального закладу, безпосереднього'
      ' керівника СОБ.\n'
      '4. За згодою батьків, відібрати пояснення у малолітнього, який вчинив'
      ' правопорушення, та свідків.\n'
      '5. Кваліфікувати правопорушення відповідно до КУпАП.\n'
      '6. Скласти протокол на одного із батьків або усиновителів, опікунів,'
      ' піклувальників за **ч. 1 ст. 184 КУпАП**.\n\n'
      '📎 **До протоколу обов’язково додається:**\n'
      '• Копія свідоцтва про народження;\n'
      '• Копія паспорта;\n'
      '• Характеристика учня;\n'
      '• Рапорт;\n'
      '• Відео з БК (бодікамери);\n'
      '• Пояснення особи, щодо якої складається протокол;\n'
...
def under16_algorithm_info(message):
  text = (
      '👶 **Фіксування адміністративного правопорушення, вчиненого'
      ' неповнолітнім, віком від 14 до 16 років**\n\n'
      '📌 *Примітка: складається протокол за ч. 3 ст. 184 КУпАП.*\n\n'
      '🔹 **Алгоритм дій:**\n'
      '1. Фіксація правопорушення, збирання доказів або будь-яких фактичних'
      ' даних, які свідчать про вчинення правопорушення.\n'
      '2. Встановлення особи (учень якого класу, хто класний керівник).\n'
      '3. Повідомити адміністрацію навчального закладу, безпосереднього'
      ' керівника СОБ, батьків (запросити до навчального закладу).\n'
      '4. За згодою батьків, відібрати пояснення у неповнолітнього, який вчинив'
      ' правопорушення, та свідків.\n'
      '5. Кваліфікувати правопорушення відповідно до КУпАП.\n'
      '6. Скласти протокол на одного із батьків або усиновителів, опікунів,'
      ' піклувальників за **ч. 3 ст. 184 КУпАП**.\n\n'
      '📎 **До протоколу обов’язково додається:**\n'
      '• Копія свідоцтва про народження або паспорта громадянина України;\n'
      '• Копія паспорта (особи, щодо якої складається протокол);\n'
      '• Характеристика учня;\n'
      '• Рапорт;\n'
      '• Відео з БК;\n'
      '• Пояснення особи, щодо якої складається протокол;\n'
      '• Пояснення особи, яка вчинила правопорушення;\n'
      '• Пояснення свідків (за наявності).'
  )
  bot.send_message(message.chat.id, text, parse_mode='Markdown')
...
def under18_algorithm_info(message):
  text = (
      '👦 **Фіксування адміністративного правопорушення, вчиненого'
      ' неповнолітнім, віком від 16 до 18 років**\n\n'
      '📌 *Примітка: складається протокол на неповнолітнього.*\n\n'
      '🔹 **Алгоритм дій:**\n'
      '1. Фіксація правопорушення, збирання доказів або отримання будь-яких'
      ' фактичних даних, які свідчать про вчинення правопорушення.\n'
      '2. Встановлення особи (учень якого класу, хто класний керівник).\n'
      '3. Повідомити адміністрацію навчального закладу, безпосереднього'
      ' керівника СОБ, батьків (запросити до навчального закладу).\n'
      '4. За згодою батьків та у їх присутності, відібрати пояснення у'
      ' неповнолітнього, який вчинив правопорушення.\n'
      '5. Кваліфікувати правопорушення відповідно до КУпАП.\n'
      '6. Скласти протокол на неповнолітнього (обов’язково у присутності'
      ' батьків, усиновителів, опікунів або піклувальників).\n\n'
      '📎 **До протоколу обов’язково додається:**\n'
      '• Копія паспорта громадянина України (особи, щодо якої складається'
      ' протокол);\n'
      '• Характеристика учня;\n'
      '• Рапорт;\n'
      '• Відео з БК;\n'
...
@bot.message_handler(
    func=lambda message: bool(message.text) and 'Фізичне' in message.text
)
...
@bot.message_handler(
    func=lambda message: bool(message.text) and 'Психологічне' in message.text
)
...
@bot.message_handler(
    func=lambda message: bool(message.text) and 'Економічне' in message.text
)
def economic_violence_info(message):
  fabula_text = (
      ...
      ' насильство економічного характеру, яке полягало у свідомому позбавленні'
      ' її житла/коштів/майна або пошкодженні власного майна (розбив телефон),'
...
def child_violence_info(message):
  fabula_text_1 = (
      ...
      '───────────────────\n\n'
      '⚖️ **Фабула (ч. 2 ст. 173-2 КУпАП — Насильство у присутності'
      ' дитини):**\n\n08.02.2026 гр. Іванов І. І. учинив стосовно своєї дружини'
      ' Іванової А. П. у присутності малолітньої дитини Іванової О. І., 2018 р.'
      ' н., домашнє насильство, чим заподіяв шкоду психічному здоров’ю'
      ' малолітньої дитини.'
  )
  fabula_text_2 = (
...
@bot.message_handler(
    func=lambda message: bool(message.text) and '173-4' in message.text
)
def art_173_4_info(message):
  text_part1 = (
      ...
      ' особи.\n\n───────────────────\n\n⚖️ **ПРИКЛАД ФАБУЛИ ЗА СТ. 173-4 КУпАП'
      ' Ч. 1**\n*(Вчинення булінгу щодо учасника освітнього'
      ' процесу)*\n\n«Такого-то числа, місяця, року приблизно в обідній час'
      ' (наприклад, о 10:30 год.), перебуваючи в приміщенні коридору [назва'
      ' закладу освіти], громадянин(ка) [ПІБ кривдника], будучи учасником'
      ' освітнього процесу, вчинив(ла) психологічний/фізичний булінг (цькування)'
      ' стосовно учня/вчителя [ПІБ потерпілого], що полягав у [описати конкретні'
      ' дії: образливі висловлювання, погрози, штовхання тощо], внаслідок чого'
      " була заподіяна шкода психічному/фізичному здоров'ю потерпілого, що"
      ' виявилося в [описати наслідки: страх, тривога, приниження], чим'
      ' порушено ст. 173-4 ч. 1 КУпАП».'
  )

  text_part2 = (
      '⚖️ **ПРИКЛАД ФАБУЛИ ЗА СТ. 173-4 КУпАП Ч. 3**\n*(Вчинення булінгу'
      ' малолітніми або неповнолітніми віком від 14 до 16 років —'
      ' відповідальність батьків)*\n\n«Протягом періоду з [дата] по [дата]'
      ' малолітня/неповнолітня особа [ПІБ дитини, вік], вчинив(ла) булінг'
      ' (цькування) щодо учня [ПІБ потерпілого] у закладі освіти [назва'
      ' школи], який виявився у [детально описати епізоди цькування, дати та'
      ' час]. У зв\'язку з чим громадянин(ка) [ПІБ матері/батька або опікуна],'
      " будучи батьком/матір'ю правопорушника, не виконав(ла) обов'язків щодо"
      ' виховання дитини, чим скоїв(ла) правопорушення, передбачене ч. 3 ст.'
      ' 173-4 КУпАП».\n\n───────────────────\n\n⚖️ **ПРИКЛАД ФАБУЛИ ЗА СТ. 173-4'
      ' КУпАП Ч. 5**\n*(Неповідомлення керівником закладу освіти про'
      ' булінг)*\n\n«Громадянин(ка) [ПІБ директора], обіймаючи посаду керівника'
      ' закладу освіти [назва школи, адреса], станом на [дата] в порушення'
      ' вимог законодавства не повідомив(-ла) уповноважений підрозділ органів'
      ' Національної поліції України про випадок булінгу (цькування) стосовно'
      ' учня [ПІБ], який мав місце [дата, час] у зазначеному закладі освіти,'
      ' чим вчинив(-ла) адміністративне правопорушення, передбачене ч. 5 ст.'
      ' 173-4 КУпАП».'
  )

  bot.send_message(message.chat.id, text_part1, parse_mode='Markdown')
  bot.send_message(message.chat.id, text_part2, parse_mode='Markdown')
