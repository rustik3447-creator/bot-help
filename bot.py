...
def handle_bullying_callbacks(call):
    ...
    if call.data == "bull_main":
        ...
        text = (
            ...
            "4. Нерівність сил\n\n"
            "⚠️ <i>Якщо все вищеперераховане сходиться — далі працюємо за алгоритмом булінгу. Перше звернення щодо булінгу максимально документуємо (відбираємо пояснення, після засідання комісії беремо копію протоколу засідання комісії) це потрібно для підтвердження сестиматичності щодо булінгу.\n"
