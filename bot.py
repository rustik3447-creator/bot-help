...
def handle_bullying_callbacks(call):
    ...
    if call.data == "bull_main":
        ...
        text = (
            ...
            "1. <b>Невідкладно (не пізніше трьох годин):</b> Повідомлення поліції, служби у справах дітей та батьків керівником закладу.\n"
            ...
            "3. <b>До 10 робочих днів:</b> Загальний строк проведення. Факт вчинення булінгу (цькування) встановлюється виключно рішенням суду, яке набрало законної сили, і не є метою чи завданням комісії.
Рішення комісії приймаються обов'язковим дотриманням принципу найкращих інтересів дитини. Комісія зобов'язана забезпечити право дитини бути вислуханою відповідно до її віку та рівня зрілості..\n\n"
