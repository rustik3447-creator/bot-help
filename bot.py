...
def handle_bullying_callbacks(call):
    ...
    if call.data == "bull_main":
        ...
        text = (
            "<b>🏛 ДІЇ КЕРІВНИКА ЗЗСО ЗГІДНО НАКАЗУ МОН № 1646</b>\n\n"
            "<b>1. Невідкладне інформування (протягом 1 доби):</b>\n"
            "• Повідомити уповноважений підрозділ Нацполіції (ювенальну превенцію / 102);\n"
            "• Повідомити службу у справах дітей (СДД);\n"
            "• Повідомити батьків або інших законних представників сторін булінгу (постраждалого та булера).\n\n"
            "<b>2. Скликання Комісії з розгляду випадків булінгу:</b>\n"
            "• Видати наказ про скликання комісії протягом <b>3 робочих днів</b> з дня отримання заяви або повідомлення про випадок булінгу.\n\n"
            "<b>3. Проведення розслідування:</b>\n"
            "• Забезпечити роботу комісії. Загальний строк розгляду справи комісією та ухвалення рішення — не більше <b>10 робочих днів</b> з дня надходження заяви/повідомлення.\n\n"
            "<b>4. Першочергові заходи безпеки:</b>\n"
            "• Прийняти рішення про вжиття невідкладних заходів для припинення булінгу та гарантування безпеки сторін (за потреби залучити практичного психолога / соціального педагога);\n"
            "• Направляти (за потреби) сторони булінгу до потребних служб чи медичних закладів.\n\n"
            "<b>5. Затвердження рішення та заходи реагування:</b>\n"
            "• Оформити рішення комісії протоколом;\n"
            "• У разі підтвердження факту булінгу — розробити та затвердити план заходів із запобігання та протидії булінгу для конкретного випадку, а також забезпечити надання психолого-педагогічних послуг учасникам освітнього процесу."
        )
        bot.edit_message_text(
            chat_id=call.message.chat.id,
            message_id=call.message.message_id,
