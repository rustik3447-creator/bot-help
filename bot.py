...
def under14_algorithm_info(message):
  text = (
      ...
      '• Копія паспорта особи, стосовно якої складається протокол;\n'
      '• Рапорт;\n'
      '• Відео з БК;\n'
      '• Пояснення особи, щодо якої складається протокол;\n'
      '• Пояснення свідків (за наявності);\n'
...
def art_173_4_info(message):
  text_part1 = (
      ...
      ' Іванов І. І., будучи учасником освітнього процесу, учнем 5-А класу,'
      ' вчинив психологічний булінг стосовно учня 6-Б класу Петренко П. П., що'
      ' полягав у образливих висловлюваннях, погрозах, внаслідок чого була'
      " заподіяна шкода психічному здоров'ю потерпілого, що виявилося в"
      ' приниженні гідності, чим порушено ст. 173-4 ч. 1 КУпАП».\n\n'
      '───────────────────\n\n'
