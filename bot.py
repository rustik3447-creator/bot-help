...
def handle_vnp_report_example(call):
    ...
    text = (
        ...
        "На місці працювали екіпаж КУПОЛ 1202, СОГ ХРУП 1 капітан поліції Лучкін В. В., ДСНС начальник ДПРЧ 18 підполковник ДСНС Завірюха, "
        "ВТС - старший інспектор ВЗВ УВТМ Лемішка О. А., СБУ.\n\n"
        "За результатами перевірки вибухонебезпечних предметів не виявлено. Об'єктом була батарейка 18650 з перемикачем.\n\n"
        "ЄО 14051 ХРУП 1."
    )
    bot.send_message(call.message.chat.id, text, parse_mode='HTML')

# --- Запуск Flask у окремому потоці та старт бота ---
