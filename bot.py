...
URL_MONTHLY_ZZSO_3 = "https://docs.google.com/forms/d/e/1FAIpQLSeVamGpP9ZLbvKoZ4RX2lKo14Kd2pdtahK4w0vSkkDgKa4XPg/viewform"
URL_MONTHLY_ZZSO_83 = "https://docs.google.com/forms/d/e/1FAIpQLSfiOXtKT1qZk9mQwVGpAyZI4x3KxdaHbShVYO5aysASNaJCdQ/viewform"
URL_MONTHLY_ZZSO_88 = "https://docs.google.com/forms/d/e/1FAIpQLScY1gR9om9urj_J7XtOtR7XzizfjBZszaNJGrJr-nCQ0yI4sA/viewform"
URL_MONTHLY_ZZSO_91 = "https://docs.google.com/forms/d/e/1FAIpQLSe8MuCCPbr-B0nw8ZzhIMpGsxMozlxVUxouKYqKG-RapbK9dA/viewform"
URL_MONTHLY_ZZSO_105 = "https://docs.google.com/forms/d/e/1FAIpQLSd1m0X2LhkmZP8b4R6S1s4XTniMr5r4pWNMkfeaEtOu5S7yDw/viewform"
URL_MONTHLY_ZZSO_107 = "https://docs.google.com/forms/d/e/1FAIpQLSfCQYdncqbJMIigWky-4Ot1WF9pXlxrFwyZWrW68K8PNhhg-w/viewform"
URL_MONTHLY_ZZSO_124 = "https://docs.google.com/forms/d/e/1FAIpQLSf2ozWkXEepr6sd8db8LCsL00uBm5WbPbNp00Z8x7TUCKk6Rw/viewform"
URL_MONTHLY_ZZSO_138 = "https://docs.google.com/forms/d/e/1FAIpQLSfBcjkwt6xJlsyY3oOBeFhhNIVHunll84RHYa3wyDcr7-gJZg/viewform"
URL_MONTHLY_ZZSO_152 = "https://docs.google.com/forms/d/e/1FAIpQLSdYuiy_MsPEMIOH3I_z2IBfnfI4EORej6Bsoafk__mhGidozQ/viewform"
URL_MONTHLY_ZZSO_153 = "https://docs.google.com/forms/d/e/1FAIpQLSc_3PtAUm46SJyLDw0hCWcKL9xd5k6dg2vhQAJp7whYzbR7-A/viewform"
...
def get_algorithms_menu():
    ...
    markup.add('🔪 Виявлення предмета схожого на зброю')
    markup.add('🔙 Головне меню')
    return markup
...
def handle_daily_reports_select(message):
    bot.send_message(
        message.chat.id,
        '📅 **(Форма "Щоденний звіт" заповнюється інспектором щоденно до 16 години) Оберіть ваш навчальний заклад (ЗЗСО) для подачі щоденного звіту:**',
...
def handle_bullying_callbacks(call):
    ...
    if call.data == "bull_main":
        ...
        text = (
            ...
            "1. Систематичність (повторюваність, 2 рази протягом 12 місяців)\n"
            "2. Наслідки\n"
            "3. Умисність поведінки\n"
            "4. Спрямованість проти конкретної особи\n"
            "5. Психологічне, фізичне, економічне або сексуальне насильство, у тому числі із застосуванням електронних комунікацій.\n"
            "4. Нерівність сил\n\n"
            "⚠️ <i>Якщо все вищеперераховане сходиться — далі працюємо за алгоритмом булінгу. Перше звернення щодо булінгу максимально документуємо (відбираємо пояснення, після засідання комісії беремо копію протоколу засідання комісії) це потрібно для підтвердження систематичності щодо булінгу.\n"
        ...
        text = (
            ...
            "<b>До складу входять (комісія створюється одна на рік та погоджується з ДЕПАРТАМЕНТОМ ОСВІТИ):</b>\n"
            "• Голова комісії — керівник закладу освіти (директор)\n"
            "• Заступник голови та секретар комісії\n"
            "• Представник Національної поліції (СОБ, СЮП, ШОП). За погодженням!\n"
...
# --- АЛГОРИТМ: ВИЯВЛЕННЯ ПРЕДМЕТА СХОЖОГО НА ЗБРОЮ ---

@bot.message_handler(
    func=lambda message: bool(message.text) and 'схожого на зброю' in message.text.lower()
)
def weapon_algorithm_info(message):
    text = (
        "<b>🔪 АЛГОРИТМ ДІЙ ІНСПЕКТОРА СОБ У РАЗІ ВИЯВЛЕННЯ У ДИТИНИ ПРЕДМЕТА, СХОЖОГО НА ЗБРОЮ</b>\n\n"
        "📹 <b>Безперервна відеофіксація на службову камеру!</b>\n\n"
        "<b>📥 Отримання інформації:</b>\n"
        "1. Самовиявлення.\n"
        "2. Інформація надійшла від учнів ЗЗСО.\n"
        "3. Від класного керівника та/або інших вчителів.\n"
        "4. Від технічного персоналу ЗЗСО.\n"
        "5. Від охоронців.\n\n"
        "<b>🛡 ЗАБЕЗПЕЧЕННЯ БЕЗПЕКИ:</b>\n"
        "1. <b>Власна безпека:</b> використовувати засоби індивідуального захисту (бронежилет, каска) та мати при собі аптечку.\n"
        "2. Не допускати інших дітей до місця події.\n"
        "3. За можливості відвести учнів з небезпечної зони.\n"
        "4. Не допустити передачі предмета іншим особам.\n"
        "5. Не провокувати конфлікт із учнем.\n\n"
        "<b>🔴 Якщо предмет знаходиться в руках учня:</b>\n"
        "1. Звертатись до учня чітко та спокійно.\n"
        "2. Подаємо усними чіткими голосними командами покласти предмет на безпечну поверхню та відійти від нього.\n"
        "3. Не намагатися силою забрати предмет, якщо це може створити безпосередньо загрозу життю та здоров’ю.\n\n"
        "<b>⚠️ Якщо дитина не реагує:</b>\n"
        "• Зайняти безпечне місце та слідкувати, щоб сторонні люди не наближались до місця події.\n"
        "• Продовжувати голосно подавати команди.\n\n"
        "<b>🚪 Організація евакуації:</b>\n"
        ...
        "<b>🚨 Негайно повідомити:</b>\n"
        "1. Администрацію закладу освіти.\n"
        "2. Чергову частину поліції.\n"
        "3. Безпосереднього керівника.\n"
        "4. Викликати екстрені служби (за необхідністю).\n"
        "5. Здійснювати охорону місця події до прибуття СОГ та вибухотехніків.\n"
        "6. Далі діяти за їх вказівкою до завершення події.\n"
        "7. Зафіксувати, хто працював на місці (старшого СОГ, представника ДСНС, екіпажа ПП та інші).\n"
        "8. Подача електронного рапорта в групу.\n"
        "9. В планшеті з додаванням фотографій, осіб, речей та дій.\n"
        "10. За потреби письмовий рапорт."
    )
