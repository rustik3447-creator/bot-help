...
def domestic_violence_algorithm_info(message):
    alg_text_1 = (
        "🛡 **АЛГОРИТМ ДІЙ ІНСПЕКТОРА СЛУЖБИ ОСВІТНЬОЇ БЕЗПЕКИ (СОБ) ПРИ ВИЯВЛЕННІ ОЗНАК ДОМАШНЬОГО НАНОСИЛЬСТВА ЩОДО ДИТИНИ**\n\n"
        "1️⃣ **Отримання інформації**\n"
        "Інформація може надійти:\n"
        "• від самої дитини;\n"
        "• від педагогів;\n"
        "• від психолога;\n"
        "• від батьків;\n"
        "• від однокласників;\n"
        "• від сусідів;\n"
        "• під час профілактичної бесіди;\n"
        "• під час огляду дитини (синці, подряпини тощо).\n\n"
        "───────────────────\n\n"
        "2️⃣ **Оцінити рівень небезпеки**\n"
        "Насамперед визначити:\n"
        "• Чи перебуває дитина зараз у небезпеці?\n"
        "• Чи знаходиться поруч можливий кривдник?\n"
        "• Чи потребує дитина медичної допомоги?\n"
        "• Чи існує ризик повторного насильства?\n\n"
        "⚠️ *Якщо є реальна загроза життю або здоров’ю — діяти негайно.*\n\n"
        "───────────────────\n\n"
        "3️⃣ **Забезпечити безпеку дитини**\n"
        "• відвести дитину у безпечне місце;\n"
        "• не залишати її наодинці;\n"
        "• не допускати контакту з можливим кривдником;\n"
        "• заспокоїти дитину;\n"
        "• не звинувачувати її;\n"
        "• пояснити, що вона перебуває у безпеці.\n\n"
        "───────────────────\n\n"
        "4️⃣ **Якщо є тілесні ушкодження**\n"
        "• викликати швидку медичну допомогу (103);\n"
        "• повідомити адміністрацію школи;\n"
        "• забезпечити огляд лікарем;\n"
        "• не дозволяти приховувати ушкодження.\n\n"
        "───────────────────\n\n"
        "5️⃣ **Первинне опитування дитини**\n"
        "Опитування проводити спокійно, без тиску. Важливо у присутності психолога або класного керівника.\n\n"
        "З’ясувати:\n"
        "• хто завдав шкоди;\n"
        "• ким ця особа є дитині;\n"
        "• коли це сталося;\n"
        "• де саме;\n"
        "• що сталося;\n"
        "• чи було таке раніше;\n"
        "• чи є інші потерпілі;\n"
        "• чи є свідки.\n\n"
        "⚠️ *Не ставити навідних запитань.*\n\n"
        "───────────────────\n\n"
        "6️⃣ **Визначити вид насильства**\n"
        "• **Фізичне:** удари, штовхання, душіння, опіки, побиття, позбавлення їжі.\n"
        "• **Психологічне:** образи, приниження, погрози, залякування, ізоляція, постійний контроль.\n"
        "• **Економічне:** позбавлення їжі, заборона користуватися речами, позбавлення коштів, залишення без необхідних умов життя.\n"
        "• **Сексуальне:** будь-які сексуальні дії щодо дитини, примушування, демонстрація порнографії, розбещення."
    )
    ...
    alg_text_2 = (
        ...
        "Необхідно:\n"
        "• записати пояснення;\n"
        "• сфотографувати ушкодження (якщо це дозволено процедурою);\n"
        "• встановити свідків;\n"
        "• зберегти можливі докази;\n"
        "• зафіксувати час та місце події.\n\n"
        "───────────────────\n\n"
        "8️⃣ **Повідомити відповідні служби**\n"
        "Обов’язково повідомити:\n"
        "• адміністрацію закладу освіти;\n"
        "• чергову частину поліції;\n"
        "• ювенальну превенцію;\n"
        "• службу у справах дітей.\n\n"
        "За необхідності:\n"
        "• мобільну бригаду соціально-психологічної допомоги;\n"
        "• центр соціальних служб.\n\n"
        "───────────────────\n\n"
        "9️⃣ **Надати правову оцінку**\n"
        "• **Якщо встановлено адміністративне правопорушення:** оформлюються матеріали за ст. 173-2 КУпАП (домашнє насильство).\n"
        "• **Якщо є ознаки злочину** (середні або тяжкі тілесні ушкодження, сексуальне насильство, катування, систематичне домашнє насильство тощо): інформація невідкладно передається для внесення відомостей до ЄРДР, після чого проводиться досудове розслідування.\n\n"
        "───────────────────\n\n"
        "🔟 **Повідомити батьків**\n"
        "• Якщо кривдником **не є один із батьків**: повідомити законних представників.\n"
        "• Якщо кривдник — **один із батьків або законний представник**: діяти через службу у справах дітей та уповноважені підрозділи поліції; не передавати дитину можливому кривднику.\n\n"
        "───────────────────\n\n"
        "1️⃣1️⃣ **Забезпечити психологічну допомогу**\n"
        "За потреби:\n"
        "• залучити практичного психолога;\n"
        "• організувати кризове консультування;\n"
        "• забезпечити підтримку дитини до прибуття відповідних служб.\n\n"
        "───────────────────\n\n"
        "1️⃣2️⃣ **Документування**\n"
        "Інспектор СОБ:\n"
        "• складає службовий рапорт;\n"
        "• долучає пояснення;\n"
        "• зазначає всіх учасників події;\n"
        "• передає матеріали за належністю.\n\n"
        "⸻\n\n"
...
def child_violence_info(message):
    fabula_text_1 = (
        ...
        "(запах алкоголю з порожнини рота, виражене тремтіння пальців рук), учинив стосовно своего "
        ...
        "домашнє насильство, а саме умисні дії физичного та психологічного характеру, ‒ ображав нецензурною лайкою, "
