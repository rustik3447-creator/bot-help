...
# 1. Головне меню (Оновлено: замість "База знань" додано ст. 173-4 Булінг)
def get_main_menu():
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
    markup.add("⚖️ ст. 173-2 Домашнє насильство", "🚸 ст. 184 Невиконання обов'язків")
    markup.add("🏫 ст. 173-4 Булінг", "ℹ️ Про бота")
    return markup
...
# --- Розділ: ст. 173-4 КУпАП (Новий розділ — Булінг) ---
...
def about_bot(message):
    bot.send_message(
        ...
        "зразків фабул за ст. 173-2 КУпАП, ст. 184 КУпАП та ст. 173-4 КУпАП."
    )
