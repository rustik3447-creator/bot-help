...
# 4. Підменю "Алгоритми" (Додано нову кнопку)
...
# 3. Алгоритм дій у разі виявлення домашнього насильства (Новий обробник)
...
def domestic_violence_algorithm_info(message):
    alg_text = (
        "🛡 **АЛГОРИТМ ДІЙ ІНСПЕКТОРА СОБ У РАЗІ ВИЯВЛЕННЯ ДОМАШНЬОГО НАНОСИЛЬСТВА**\n\n"
        "1️⃣ **Складає службовий рапорт** про факт виявлення або отримання інформації щодо вчинення домашнього насильства.\n"
        "2️⃣ **Долучає пояснення** учасників та очевидців події.\n"
        "3️⃣ **Зазначає всіх учасників події** (кривдник, постраждала особа, свідки, зокрема діти).\n"
        "4️⃣ **Передає матеріали за належністю** (до чергової частини / уповноваженого підрозділу поліції).\n\n"
        "───────────────────\n\n"
    ...
    bot.send_message(message.chat.id, alg_text, parse_mode="Markdown")
